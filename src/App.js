					...
					<div className="max-w-6xl mx-auto px-4 pt-14 pb-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
						...
						<div className="flex flex-col gap-3">
							...
							<div className="flex items-center gap-3 pt-2">
								<a href="#" aria-label="YouTube" className="w-8 h-8 rounded-full bg-gray-800 hover:bg-accentSolid flex items-center justify-center transition-colors duration-200">
								...
								<a href="#" aria-label="Facebook" className="w-8 h-8 rounded-full bg-gray-800 hover:bg-accentSolid flex items-center justify-center transition-colors duration-200">
									<svg className="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
										<path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
									</svg>
								</a>
								<a href="#" aria-label="Instagram" className="w-8 h-8 rounded-full bg-gray-800 hover:bg-accentSolid flex items-center justify-center transition-colors duration-200">
									<svg className="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
