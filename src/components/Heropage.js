...
function Heropage(){
    return (
        ...
        <Navbar/>
        {/* Hero page content  */}
        <div className=" flex flex-col px-12 py-2 mx-1 md:grid grid-cols-2 gap-4 md:p-12 mt-2 mx-5 justify-center">
            <div className="grid md:justify-items-start gap-3">
                ...
                <h1 className="max-w-2xl md:mb-4 text-4xl text-accentTextContrast font-extrabold tracking-widest leading-none md:text-5xl xl:text-6xl dark:text-accentTextContrast-dark">Beauty of Islam</h1>
