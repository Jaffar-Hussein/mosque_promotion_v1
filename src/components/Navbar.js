			...
			<nav className='sticky top-0 z-30 bg-gray-50 bg-opacity-70 backdrop-blur backdrop-filter'>
				<div className='pt-1'>
					...
					<div className='grid grid-cols-8 justify-items-center px-3 pt-3 content-center mx-auto md:grid-cols-4 md:gap-3 md:px-8 md:py-5'>
						...
						<div
							className='col-start-8 md:hidden stroke-2 text-lg'
							...
							<div className='mt-6 flow-root'>
								<div className='-my-6 divide-y divide-accentBorder dark:divide-accentBorder-dark '>
									<div className='space-y-2 py-6'>
										{navigation.map((item) => (
											<a
												key={item.name}
												href={item.href}
												className='-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-accentText dark:text-accentText-dark hover:bg-accentBgHover dark:hover:bg-accentBgHover-dark'
											>
												{item.name}
											</a>
										))}
									...
									<div className='flex col-start-7 md:hidden '>
										...
										<label
											htmlFor='dark-mode-toggle'
											className='w-full h-full transition-transform  py-5 px-1 bg-gray-800 dark:bg-white rounded-full  flex justify-between cursor-pointer'
										>
											<span className='text-accentText dark:text-accentText-dark text-base font-medium'>
												Theme
											</span>
											<span className='hidden dark:flex '>
												<svg
